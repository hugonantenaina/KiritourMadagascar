...
const STATS = [
  { value:93,  suffix:"+",    decimals:0, label:"Happy Travellers", sub:"Voyageurs satisfaits",  Icon:IconTravellers, accent:"#facc15", glow:"rgba(250,204,21,0.25)", grad:"linear-gradient(135deg,rgba(250,204,21,0.18),rgba(250,204,21,0.04))", border:"rgba(250,204,21,0.3)" },
  { value:14,  suffix:"+",    decimals:0, label:"Tour Packages",    sub:"Circuits disponibles",  Icon:IconTours,      accent:"#34d399", glow:"rgba(52,211,153,0.25)",  grad:"linear-gradient(135deg,rgba(52,211,153,0.18),rgba(52,211,153,0.04))",  border:"rgba(52,211,153,0.3)" },
  { value:4.4, suffix:"★",    decimals:1, label:"Average Rating",   sub:"Note moyenne Google",   Icon:IconRating,     accent:"#fb923c", glow:"rgba(251,146,60,0.25)",  grad:"linear-gradient(135deg,rgba(251,146,60,0.18),rgba(251,146,60,0.04))",  border:"rgba(251,146,60,0.3)" },
  { value:3,   suffix:" ans", decimals:0, label:"Years Experience", sub:"D'expérience terrain",  Icon:IconExperience, accent:"#a78bfa", glow:"rgba(167,139,250,0.25)", grad:"linear-gradient(135deg,rgba(167,139,250,0.18),rgba(167,139,250,0.04))", border:"rgba(167,139,250,0.3)" },
];
